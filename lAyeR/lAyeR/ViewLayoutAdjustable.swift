...
extension UIView: ViewLayoutAdjustable {
    func applyViewAdjustment(_ adjustment: ARViewLayoutAdjustment) {
        ...
        view.layer.zPosition = diagonalLength + CGFloat(ARViewConstants.maxSearchDistance) - adjustment.pushBackDistance
        ...
        perspectiveTransform.m34 = -1 / ARViewConstants.projectionPlaneDistance
        ...
        transform = CATransform3DConcat(transform, pushBackTransform)
