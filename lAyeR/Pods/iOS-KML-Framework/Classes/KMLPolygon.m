...
- (KMLElement *)childElementNamed:(NSString *)name innerClass:(Class)class xmlElement:(TBXMLElement *)element;
- (void)childElementsNamed:(NSString *)name innerClass:(Class)class xmlElement:(TBXMLElement *)element eachBlock:(void (^)(KMLElement *element))eachBlock;
@end
...
- (id)init
{
    self = [super init];
    if (self) {
        _innerBoundaryIsList = @[].mutableCopy;
    }
    return self;
}
