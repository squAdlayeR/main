...
- (id)initWithXMLElement:(TBXMLElement *)element parent:(KMLElement *)parent
{
    ...
    if (self) {
        _tagName = [TBXML elementName:element];
        _xValue = [TBXML valueOfAttributeNamed:@"x" forElement:element];
        _yValue = [TBXML valueOfAttributeNamed:@"y" forElement:element];
        _xunitsValue = [TBXML valueOfAttributeNamed:@"xunits" forElement:element];
        _yunitsValue = [TBXML valueOfAttributeNamed:@"yunits" forElement:element];
    }
    return self;
}
